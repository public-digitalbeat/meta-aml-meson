...
DEPENDS = " gstreamer1.0 gstreamer1.0-plugins-base glib-2.0 zlib aml-secmem essos"
DEPENDS += "gstreamer1.0-plugins-bad"
DEPENDS += "aml-mediadrm-cleartvp-bin"

#SRC_URI = "git://${AML_GIT_ROOT}/linux/multimedia/gstreamer_plugin.git;protocol=${AML_GIT_PROTOCOL};branch=open-bsp-master"
SRC_URI = "git://${AML_GIT_ROOT}/linux-multimedia-gstreamer_plugin.git;protocol=${AML_GIT_PROTOCOL};branch=open-bsp-master"
