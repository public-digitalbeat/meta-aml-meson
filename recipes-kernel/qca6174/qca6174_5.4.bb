...
#SRC_URI = "git://${AML_GIT_ROOT}/platform/hardware/wifi/qualcomm/drivers/qca6174.git;protocol=${AML_GIT_PROTOCOL};branch=open-bsp-master"
SRC_URI = "git://${AML_GIT_ROOT}/platform-hardware-wifi-qualcomm-drivers-qca6174.git;protocol=${AML_GIT_PROTOCOL};branch=open-bsp-master"
...
COMPATIBLE_MACHINE="(mesonsc2-5.4*|mesons4-*)"
