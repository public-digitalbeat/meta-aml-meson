...
RDEPENDS_packagegroup-amlogic-common = "\
                                    ...
                                    ${@bb.utils.contains('DISTRO_FEATURES', 'verimatrix', 'vmx-plugin', '', d)} \
                                    ...
                                    vulkan-loader \
                                    volume-ctl \
                                    ${@bb.utils.contains('DISTRO_FEATURES', 'amlogic-mediainfo', 'aml-minfo mediainfo-rdkservice', '', d)} \
                                    ...
                                    ${@bb.utils.contains('DISTRO_FEATURES', 'aml-cas', 'drmplayer-bin ffmpeg', '', d)} \
                                    ${@bb.utils.contains('DISTRO_FEATURES', 'aml-cas', 'aml-cas-hal aml-secdmx', '', d)} \
                                    ${@bb.utils.contains('DISTRO_FEATURES', 'amlogic-dvb', 'dtvkit-rdkservice', '', d)} \
                                    libdrm-meson \
                                    boost \
                                    "
